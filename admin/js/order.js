        ...
        document.getElementById("cardSection").innerHTML += `
            ...
            onclick="updateOrder(${orderValue.id}, '${orderValue.order}',
             ...
             <button type="submit" class="btn btn-danger"
              onclick="deleteOrder(${orderValue.id})"><i class="fas fa-trash-alt"></i> 
              <a class="delete" onclick="return confirm('Are you sure you want to delete this item?');"> Delete Order </a>
...
function reset() {
    ...
    <form class="border p-4 md-4" id="form" >
    ...
    <button type="submit" id="button1" class="btn btn-outline-success">
        <i class="fa fa-plus">Add Order</i>
    </button>
    <button style="display: none;" id="button2" class="btn btn-outline-warning"></button>

    <button style="display: none;" id="button3" class="btn btn-outline-danger"></button>
    </form>
    `;
    document.getElementById("form").addEventListener("submit", (e) => {
        var order=document.getElementById("order").value;
...
function updateOrder(id,order,total){
    document.getElementById("firstSection").innerHTML=`
    <form class="border p-4 md-4" id="form2" >
    <div class="form-group">
        <label>Order</label>
        <input type="text" class="form-control" id="order" placeholder="order">
    </div>
    ...
    <button style="display: none;" type="submit" id="button1" class="btn btn-outline-success">
        <i class="fa fa-plus">Add Order</i>
    </button>
    <button  id="button2" class="btn btn-outline-success">Update Order</button>

    <button id="button3" class="btn btn-outline-danger">Cancel</button>
    </form>
    `;
